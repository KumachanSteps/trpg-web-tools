const I18N = {
  ja: {
    ...
    "input.note": "対応例：CCB&lt;=80、CC&lt;=60、1d100&lt;=55、RESB(10-16)、D100 など。<br>キャラクター名は「名前：CC」や「[main] 名前：CCB」形式から自動検出します。<br>[雑談] / [other] / [info] 系の行除外とd100系ロール抽出は自動適用されます。CCB中心なら6版、CC中心なら7版として判定範囲を自動調整します。少数ロールのキャラは初期状態で非表示になります。",
    ...
    "panel.howtoStep2": "必要に応じて、クリティカル上限 / ファンブル下限 / 自動非表示件数を確認し、「分析する」を押します。CCB中心なら6版、CC中心なら7版として自動調整されます。",
  ...
  en: {
    ...
    "panel.howtoStep2": "Check the critical cap, fumble floor, and auto-hide threshold if needed, then press Analyze. It auto-adjusts as 6th edition for CCB-heavy logs and 7th edition for CC-heavy logs.",
