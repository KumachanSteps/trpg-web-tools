const I18N = {
  ja: {
    ...
    "button.shortcuts": "ショートカット一覧",
    "button.screenshot": "📷 スクショ表示",
    "button.exitScreenshot": "通常表示に戻す",
    "button.postX": "Xに投稿",
    "button.downloadScreenshot": "ダウンロード",
    "button.copyScreenshot": "コピー＆ペースト",
    "screenshot.downloadWorking": "スクショ画像を生成しています...",
    "screenshot.downloadSuccess": "スクショ画像をダウンロードしました。",
    "screenshot.downloadError": "ダウンロードに失敗しました。ブラウザ設定をご確認ください。",
    "screenshot.copyWorking": "スクショ画像をコピーしています...",
    "screenshot.copySuccess": "スクショ画像をクリップボードにコピーしました。",
    "screenshot.copyError": "コピーに失敗しました。Chrome / Edgeなど対応ブラウザでお試しください。",
    "screenshot.xWorking": "画像をコピーしてX投稿画面を開きます...",
    "screenshot.xSuccess": "画像をコピーしました。X投稿画面で貼り付けてください。",
    "screenshot.xCopyFallback": "X投稿画面を開きました。画像は手動で添付してください。",
    "screenshot.xError": "X投稿画面を開けませんでした。",
  ...
  en: {
    ...
    "button.postX": "Post to X",
    "button.downloadScreenshot": "Download",
    "button.copyScreenshot": "Copy & Paste",
    "screenshot.downloadWorking": "Generating screenshot...",
    "screenshot.downloadSuccess": "Screenshot downloaded.",
    "screenshot.downloadError": "Download failed. Please check your browser settings.",
    "screenshot.copyWorking": "Copying screenshot...",
    "screenshot.copySuccess": "Screenshot copied to clipboard.",
    "screenshot.copyError": "Copy failed. Please try Chrome, Edge, or another supported browser.",
    "screenshot.xWorking": "Copying image and opening X compose...",
    "screenshot.xSuccess": "Image copied. Paste it into the X compose screen.",
    "screenshot.xCopyFallback": "X compose opened. Please attach the image manually.",
    "screenshot.xError": "Could not open X compose.",
