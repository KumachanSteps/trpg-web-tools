...
const CATEGORY_6E = {
  ...
  explore: ["目星", "聞き耳", "図書館"],
  combat: ["回避", "こぶし", "キック", "組み付き", "頭突き", "投擲", "マーシャルアーツ", "拳銃", "サブマシンガン", "ショットガン", "マシンガン", "ライフル", "日本刀", "短刀", "太刀", "メイス", "ノコギリナタ", "ナタ"],
...
window.ChatPaletteParser = (() => {
  ...
  function runSelfTests() {
    const tests = [
      {
        name: "6e classifies Japanese swords as combat",
        actual: buildOutput("CCB<=85 【日本刀：太刀】" + NL + "CCB<=80 【日本刀：短刀】", "6e").includes("🟥戦闘技能"),
        expected: true
      },
      {
        name: "6e classifies mace and nokogiri-nata as combat",
        actual: buildOutput("CCB<=65 【メイス】" + NL + "CCB<=70 【ノコギリナタ】", "6e").includes("🟥戦闘技能"),
        expected: true
      },
      {
